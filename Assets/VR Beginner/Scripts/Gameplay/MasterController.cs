...
public class MasterController : MonoBehaviour
{
    ...
    InteractionLayerMask m_OriginalRightInteractionLayers;
    InteractionLayerMask m_OriginalLeftInteractionLayers;
    ...
    void Start()
    {
        ...
        m_OriginalRightInteractionLayers = RightTeleportInteractor.interactionLayers;
        m_OriginalLeftInteractionLayers = LeftTeleportInteractor.interactionLayers;
    ...
    void RightTeleportUpdate()
    {
        ...
        RightTeleportInteractor.interactionLayers = m_OriginalRightInteractionLayers;
    ...
    void LeftTeleportUpdate()
    {
        ...
        LeftTeleportInteractor.interactionLayers = m_OriginalLeftInteractionLayers;
