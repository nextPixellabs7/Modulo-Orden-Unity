...
public class DialInteractable : UnityEngine.XR.Interaction.Toolkit.Interactables.XRBaseInteractable
{
    ...
    {
        var interactor = args.interactorObject; // Usar interactorObject en lugar de interactor (obsoleto)
        // Conversión explícita de IXRSelectInteractor a XRBaseInteractor
        m_GrabbedRotation = interactor.transform.rotation;
        m_GrabbingInteractor = interactor as UnityEngine.XR.Interaction.Toolkit.Interactors.XRBaseInteractor;
